...
const Animacion6 = () => {
    ...
    useEffect(() => {
        Animated.loop( // sirve para repetir la animacion
            Animated.sequence([ // Sirve para crear varias animaciones anidadas 
    ...
    return ( 
        <View style={{ alignItems: 'center'}}>
            <Animated.View style={[styles.caja, estiloAnimaciones]}>
